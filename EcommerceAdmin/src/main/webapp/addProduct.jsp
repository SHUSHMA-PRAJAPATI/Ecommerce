<%@page import="com.admin.ecommerce.helper.FactoryProvider"%>
<%@page import="com.admin.ecommerce.entity.Category"%>
<%@page import="java.util.List"%>
<%@page import="com.admin.ecommerce.dao.CategoryDao"%>
...
<div class="card card-info col-8 my-5">
              ...
              <!-- form start -->
              <form action="ProductOperationServlet" enctype="multipart/form-data" method="post" class="form-horizontal">
                <div class="card-body">
                ...
                %>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" name="productPrice" class="form-control-file" placeholder="Product Price">
                    </div>
                  </div>
                 <div class="form-group row">
